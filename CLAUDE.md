One-paragraph context (paste once at top of every AI session)
...
Balanced power plan → Info

If plan name contains "Balanced"

High CPU temp → Warning

If CpuPackageTempC >= 95

Unknown required fields → Info
